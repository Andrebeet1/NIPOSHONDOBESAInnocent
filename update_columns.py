...
# Ce script agrandit les champs de la table 'reponse' sans effacer les données
...
print("✅ Toutes les colonnes ont été agrandies avec succès sans perte de données.")
